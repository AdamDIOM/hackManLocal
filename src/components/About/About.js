        ...
        <Container className="About">
            <Row className="aboutContent">
                ...
                <Col md={6} sm={12}>
                    ...
                    <h2>Where are we?</h2>
                    <p>Whilst our venue is currently not confirmed, hackMan Local 2023 will be held on the Isle of Man. We look forward to seeing you there! Due to losing our previously planned venue, we have had to postpone this event indefinitely, however please register your interest <a href="https://hackman.im/register" target="_blank" rel="noreferrer">here</a>!</p>
                </Col>
            </Row>
        </Container>
    )
